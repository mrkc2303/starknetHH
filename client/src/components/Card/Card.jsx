...
const apiKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweGZENzAwNkUzNDk2REM5QTlkNGRCMmRlN2Y5NTBlN0M3MmYwZjU3NTQiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTY5MjAyMDYzMzkyNSwibmFtZSI6IlNlZCBWYWkifQ.PpABS7QPJjW59sNKrIZWIZ3BW7gP0UBJ-2fZj7GNgC0";
...
const Card = ({
  ...
  const {contract} = useConnectContext();
  ...
  const TransferNftOnBuy = async () => {
    ...
    const sendTo = window.prompt(
      "Who do you wanna Gift to?",
      "tz1eiNsheTtnSb6dLFFZSZUQJWArseHM6Yfr"
    );
  ...
  return (
    <div className="card w-[360px]">
      <div className="image">
        {isDiff ? (
          <img className="rounded-t-lg" src={newUrl} alt="" />
        ) : (
          <div>
      ...
      <div className="details max-w-[360px]">
        <div className="center">
          ...
          <p className="font-montserrat text-[#fff]">
